    ...
    async function _install() {
        ...
        if (!opts.lockfileOnly &&
            ...
            if (!ctx.existsWantedLockfile) {
                ...
                logger_1.default.info({ message: 'Lockfile is up-to-date, resolution step is skipped', prefix: opts.lockfileDirectory });
...
function linkBinsOfImporter({ modulesDir, bin, prefix }) {
    ...
    return link_bins_1.default(modulesDir, bin, { allowExoticManifests: true, warn });
}
