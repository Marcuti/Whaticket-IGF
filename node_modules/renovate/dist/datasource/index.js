...
async function getPkgReleases(config) {
    ...
    const versionScheme = config && config.versionScheme ? config.versionScheme : 'semver';
...
function getDigest(config, value) {
    ...
    return datasources[config.datasource].getDigest({ lookupName, registryUrls }, value);
}
module.exports = {
    getPkgReleases,
    supportsDigests,
