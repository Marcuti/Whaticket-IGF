...
gradle.buildFinished {
   ...
   outputFile.write json
    ...
    logger.debug('Creating renovate-plugin.gradle file with renovate gradle plugin');
...
function combineReposOnDuplicatedDependencies(accumulator, currentValue) {
    ...
    if (!existingDependency) {
        ...
        const nonExistingRepos = currentValue.repos.filter(repo => existingDependency.repos.indexOf(repo) === -1);
