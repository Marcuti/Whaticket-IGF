...
async function generateLockFile(cwd, env, binarySource) {
    ...
    try {
        ...
        try {
            ...
            const installedPath = upath.join(await getInstalledPath('pnpm', {
                local: true,
            }), 'lib/bin/pnpm.js');
            ...
            try {
                ...
                try {
                    const installedPath = upath.join(await getInstalledPath('pnpm'), 'lib/bin/pnpm.js');
                    cmd = `node ${installedPath}`;
                }
                catch (globalerr) {
        ...
        logger.info({ seconds, type: 'pnpm-lock.yaml', stdout, stderr }, 'Generated lockfile');
    }
