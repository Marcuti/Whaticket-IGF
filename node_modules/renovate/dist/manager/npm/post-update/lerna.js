...
async function generateLockFiles(lernaClient, cwd, env, skipInstalls, binarySource) {
    if (!lernaClient) {
    ...
    try {
        ...
        logger.info({ type: 'lerna', seconds, lernaClient, stdout, stderr }, 'Generated lockfile');
    }
