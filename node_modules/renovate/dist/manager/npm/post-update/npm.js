...
async function generateLockFile(cwd, env, filename, config = {}, upgrades = []) {
    ...
    try {
        ...
        try {
            ...
            const installedPath = upath.join(await getInstalledPath('npm', {
                local: true,
            }), 'bin/npm-cli.js');
            ...
            try {
                ...
                // look for global npm
                try {
                    const installedPath = upath.join(await getInstalledPath('npm'), 'bin/npm-cli.js');
                    cmd = `node ${installedPath}`;
                }
                catch (globalerr) {
        ...
        logger.info({ seconds, type: filename, stdout, stderr }, 'Generated lockfile');
    }
