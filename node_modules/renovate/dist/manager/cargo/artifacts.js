...
async function getArtifacts(packageFileName, updatedDeps, newPackageFileContent, config) {
    ...
    if (!config.gitFs) {
        logger.warn('Renovate administrator should enable gitFs in order to support Cargo.lock updating');
        return null;
    }
    ...
    try {
        ...
        for (let i = 0; i < updatedDeps.length; i += 1) {
            ...
            logger.info({ seconds, type: 'Cargo.lock', stdout, stderr }, 'Updated lockfile');
        }
