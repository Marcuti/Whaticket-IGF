...
function extractPackageFile(content) {
    ...
    definitions.forEach(def => {
        ...
        if (depType === 'git_repository' &&
            ...
            if (remote) {
                const remoteMatch = remote.match(/https:\/\/github\.com(?:.*\/)(([a-zA-Z]+)([-])?([a-zA-Z]+))/);
            ...
            logger.info({ def }, 'Failed to find dependency in bazel WORKSPACE definition');
        }
    });
    if (!deps.length) {
        return null;
