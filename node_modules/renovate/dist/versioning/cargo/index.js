...
const isLessThanRange = (version, range) => npm.isLessThanRange(version, cargo2npm(range));
...
const maxSatisfyingVersion = (versions, range) => npm.maxSatisfyingVersion(versions, cargo2npm(range));
const minSatisfyingVersion = (versions, range) => npm.minSatisfyingVersion(versions, cargo2npm(range));
...
function getNewValue(currentValue, rangeStrategy, fromVersion, toVersion) {
    ...
    const newSemver = npm.getNewValue(cargo2npm(currentValue), rangeStrategy, fromVersion, toVersion);
