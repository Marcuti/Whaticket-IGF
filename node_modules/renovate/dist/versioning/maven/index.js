"use strict";
const { isVersion, isValid, tokenize, compare, TYPE_NUMBER, TYPE_QUALIFIER, isSingleVersion, autoExtendMavenRange, parseRange, EXCLUDING_POINT, } = require('./compare');
...
const maxSatisfyingVersion = (versions, range) => versions.find(version => matches(version, range));
