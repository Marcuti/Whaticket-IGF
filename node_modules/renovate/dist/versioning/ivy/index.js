"use strict";
const { equals, getMajor, getMinor, getPatch, isGreaterThan, isSingleVersion, isStable, matches: mavenMatches, maxSatisfyingVersion, minSatisfyingVersion, getNewValue, sortVersions, } = require('../maven/index');
const { TYPE_QUALIFIER, tokenize, isSubversion } = require('../maven/compare');
const { REV_TYPE_LATEST, REV_TYPE_SUBREV, parseDynamicRevision, } = require('./parse');
