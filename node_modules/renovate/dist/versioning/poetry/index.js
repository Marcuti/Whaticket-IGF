...
const isLessThanRange = (version, range) => npm.isLessThanRange(version, poetry2npm(range));
...
const maxSatisfyingVersion = (versions, range) => npm.maxSatisfyingVersion(versions, poetry2npm(range));
const minSatisfyingVersion = (versions, range) => npm.minSatisfyingVersion(versions, poetry2npm(range));
...
function getNewValue(currentValue, rangeStrategy, fromVersion, toVersion) {
    ...
    const newSemver = npm.getNewValue(poetry2npm(currentValue), rangeStrategy, fromVersion, toVersion);
