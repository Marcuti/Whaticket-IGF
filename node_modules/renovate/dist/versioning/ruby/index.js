"use strict";
const { eq, valid, gt, satisfies, maxSatisfying, minSatisfying, } = require('@snyk/ruby-semver');
...
const isStable = version => parseVersion(version).prerelease ? false : isVersion(version);
...
const maxSatisfyingVersion = (versions, range) => maxSatisfying(versions, range);
const minSatisfyingVersion = (versions, range) => minSatisfying(versions, range);
