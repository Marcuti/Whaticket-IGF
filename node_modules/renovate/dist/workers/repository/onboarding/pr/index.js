...
const { appName, onboardingBranch, onboardingPrTitle, urls, } = require('../../../../config/app-strings');
...
`;
    ...
    try {
        ...
        if (config.dryRun) {
            ...
            const pr = await platform.createPr(onboardingBranch, onboardingPrTitle, prBody, labels, useDefaultBranch);
