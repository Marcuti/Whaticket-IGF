...
const { configFileNames, onboardingBranch, } = require('../../../../config/app-strings');
...
async function rebaseOnboardingBranch(config) {
    ...
    const existingContents = await platform.getFile(defaultConfigFile, onboardingBranch);
    ...
    if (config.dryRun) {
        ...
        await platform.commitFilesToBranch(onboardingBranch, [
            {
