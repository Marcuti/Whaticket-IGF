...
function generateBranchConfig(branchUpgrades) {
    ...
    for (const branchUpgrade of branchUpgrades) {
        ...
        if (upgrade.semanticCommits && !upgrade.commitMessagePrefix) {
            ...
            if (upgrade.semanticCommitScope) {
                semanticPrefix += `(${handlebars.compile(upgrade.semanticCommitScope)(upgrade)})`;
            }
        ...
        if (upgrade.commitBody) {
            upgrade.commitMessage = `${upgrade.commitMessage}\n\n${handlebars.compile(upgrade.commitBody)(upgrade)}`;
        }
    ...
    config.masterIssueApproval = config.upgrades.some(upgrade => upgrade.masterIssueApproval);
